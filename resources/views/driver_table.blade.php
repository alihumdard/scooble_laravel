...
<body>
    ...
    <table id="example" class="display" style="width:100%">
        ...
        <tbody>
            <tr>
                <td><img src="assets/images/pic.jpg" style="width: 45px; height: 43px; border-radius: 38px;" alt="text"> @lang('lang.driver_name')</td>
                <td>Sep 23, 2023</td>
                ...
                <td>Write Here......</td>
                <td>
                    <button class="btn p-0" data-toggle="modal" data-target="#editdriver"><svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </button> <button class="btn p-0" data-toggle="modal" data-target="#deletedriver"><svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
